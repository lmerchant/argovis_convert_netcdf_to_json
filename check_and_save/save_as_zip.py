...
def get_json_dicts(checked_ctd_variables):
    ...
    for checked_vars in checked_ctd_variables:
        ...
        profile_dicts.append(data_dict)

    return profile_dicts, expocode


def save_as_zip(checked_ctd_variables):

    json_dicts, expocode = get_json_dicts(checked_ctd_variables)
